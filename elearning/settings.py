...
SECRET_KEY = 'django-insecure-db#8(3iukcy)(8(aw1gq!9ti(4prscf_g=kd!5@-ahyqp-esw='
...
# This tells Django to use 'accounts' app login route 
...
# The public URL path Nginx will use
STATIC_URL = '/static/'

# Where collectstatic will dump everything for Nginx
STATIC_ROOT = BASE_DIR / 'staticfiles'

# ONLY for global, project-wide static files (like a main logo or base CSS)
STATICFILES_DIRS = [
    BASE_DIR / "static", 
]
